...
const getAllBooksHandler = (request, h) => {
  ...
  const filteredBooks = books
    ...
    .filter((book) => {
      ...
      const isReadingMatch = reading === undefined
                || (reading === '0' && !book.reading)
                || (reading === '1' && book.reading);
      const isFinishedMatch = finished === undefined
                || (finished === '0' && !book.finished)
                || (finished === '1' && book.finished);
